...
- HTML version for clean A4 printing
- PDF version for direct printing
- DOCX version for editing in Microsoft Word
- ODT version for editing in LibreOffice or other open document editors

## Goal

The goal of this project is to make a simple, fair, and accessible rental contract template available to the public so that tenants and owners can start from a clearer written agreement.
